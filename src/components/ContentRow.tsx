    ...
    return (
        <div className="pt-12 pb-8 space-y-4 relative group/row">
            ...
            <div className="relative">
                ...
                <div
                    ref={rowRef}
                    className="flex overflow-x-auto gap-[18px] pb-4 pt-4 scrollbar-hide scroll-smooth no-scrollbar px-6 xl:px-[calc((100vw-1280px)/2+24px)] 2xl:px-[calc((100vw-1536px)/2+24px)]"
                >
                    {shows.map((show) => (
                        <div
                            key={show.id}
                        ...
                        >
                            <motion.div
                                className="relative w-[170px] h-[255px] flex-shrink-0 rounded-[8px] overflow-hidden cursor-pointer group/card border border-white/10"
