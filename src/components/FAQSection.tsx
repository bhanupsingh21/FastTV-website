...
const faqs = [
    {
        ...
        answer: (
            <>
                FastTV brings you 90-second micro dramas crafted for real emotional impact. Download the app, choose a story that speaks to you, and start watching{' '}
                <a href="#" className="underline decoration-solid">instantly.One</a>{' '}
                subscription. Full{' '}
                <a href="#" className="underline decoration-solid">access.No</a>{' '}
                interruptions
            </>
        )
    },
        ...
        <section className="relative w-full py-20 bg-[#040406]">
            ...
            <div className="container mx-auto px-6 relative z-10 flex flex-col lg:flex-row gap-12 lg:gap-24">
                ...
                <div className="lg:w-1/3 pt-10">
                    ...
                    <p className="text-[21px] text-white/80 leading-relaxed font-normal">
                ...
                <div className="lg:w-2/3 max-w-[800px] ml-auto">
                    {faqs.map((faq, index) => (
                        ...
                        >
                            ...
                            >
                                <span className="text-[22px] font-medium text-white group-hover:text-[#009cdb] transition-colors">
                                    {faq.question}
                                </span>
                            ...
                            <AnimatePresence>
                                {openIndex === index && (
                                    ...
                                    >
                                        <p className="pt-4 text-[19px] text-white/80 leading-relaxed">
                                            {faq.answer}
                                        </p>
                                    </motion.div>
                                )}
